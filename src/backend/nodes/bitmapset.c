 ...
 *				process member x;
 *
 * CAUTION: this destroys the contenet of "inputset". If the set must 
 ...
 *
 * This is intend as support for iterating through the member of a set.
 * The typical pattern is
 *
 *                     x = -1;
 ...
 *					          process member x;
 *
 * Notice that when tere are no more members, we return -2, not -1 as you
 * might expect. THe rationale for that is to allow distinguishing the
 * loop-not-started stste (x == -1) from the loop-completed state (x == -2).
